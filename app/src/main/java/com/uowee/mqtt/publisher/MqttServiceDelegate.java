...
public class MqttServiceDelegate {
    ...
    public interface StatusHandler {
        void handleStatus(MqttService.ConnectionStatus status, String reason);
    }
    ...
    public static class StatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MqttService.ConnectionStatus statusCode =
                    MqttService.ConnectionStatus.class.getEnumConstants()[notificationData.getInt(
